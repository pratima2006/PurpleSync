...
export function Admin(){
  const [auth,setAuth]=useState(false); const [pass,setPass]=useState(""); const [tab,setTab]=useState<'achievements'|'palette'|'updates'|'voting'|'schedule'>('achievements');
...
export function UserAdminPanel(){ return <div className="p-10 text-center">Use /admin for now</div>; }
