...
import { CalendarDays, ChevronRight, ListFilter, Mic2, Radio, Clapperboard, RotateCcw, Crown } from 'lucide-react';
    ...
    <div className="ps-page-enter ps-content py-8 md:py-12">
      ...
      {view === 'month'? (
        <>
          ...
          {/* SELECTED DATE KA BOX - CALENDAR KE BAHAR DUSRE BOX ME */}
          {selectedDate && (
            <div className="ps-panel mt-6 overflow-hidden rounded-2xl">
              <div className="border-b border-[#eeeaf3] px-5 py-4 md:px-7 flex justify-between items-center">
                <p className="text-[13px] font-semibold text-[#3d324b]">{selectedDate.getDate()} {MONTHS_FULL[selectedDate.getMonth()]} {selectedDate.getFullYear()} — Events: {selectedDayEvents.length}</p>
